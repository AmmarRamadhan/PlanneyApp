...
public class FragmentMyPlanCreate extends Fragment {
    ...
    private void newplan(String event, String amount, String description, String pick_date_from, String pick_date_until){
        progressDialog.show();
        ...
        writeUserNewPlan.setTextDateFrom(editDateFrom.getText().toString());
        writeUserNewPlan.setTextDateUntil(editDateUntil.getText().toString());
